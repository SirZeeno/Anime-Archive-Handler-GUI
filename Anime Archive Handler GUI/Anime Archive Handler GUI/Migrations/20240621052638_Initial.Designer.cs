...
namespace Anime_Archive_Handler_GUI.Migrations
{
    ...
    [Migration("20240621052638_Initial")]
            ...
            modelBuilder.Entity("MalUrl", b =>
                {
                    ...
                    b.Property<long?>("AnimeDtoMalId1")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("AnimeDtoMalId2")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("AnimeDtoMalId3")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("AnimeDtoMalId4")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("AnimeDtoMalId5")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("AnimeDtoMalId6")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("AnimeDtoMalId1");

                    b.HasIndex("AnimeDtoMalId2");

                    b.HasIndex("AnimeDtoMalId3");

                    b.HasIndex("AnimeDtoMalId4");

                    b.HasIndex("AnimeDtoMalId5");

                    b.HasIndex("AnimeDtoMalId6");
            ...
            modelBuilder.Entity("MalUrl", b =>
                {
                    ...
                    b.HasOne("AnimeDto", null)
                        ...
                        .HasForeignKey("AnimeDtoMalId1")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("AnimeDto", null)
                        .WithMany("Genres")
                        .HasForeignKey("AnimeDtoMalId2")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("AnimeDto", null)
                        .WithMany("Licensors")
                        .HasForeignKey("AnimeDtoMalId3")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("AnimeDto", null)
                        .WithMany("Producers")
                        .HasForeignKey("AnimeDtoMalId4")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("AnimeDto", null)
                        .WithMany("Studios")
                        .HasForeignKey("AnimeDtoMalId5")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("AnimeDto", null)
                        .WithMany("Themes")
                        .HasForeignKey("AnimeDtoMalId6")
                        .OnDelete(DeleteBehavior.Cascade);
                });
